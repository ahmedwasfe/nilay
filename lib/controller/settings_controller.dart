...
class SettingsController extends GetxController {
  List<Country> listCountries = [
    Country(
        id: 1,
        name: 'egypt'.tr,
        flag: 'icon_flag_egypt.svg',
        isSelected: false),
    Country(
        id: 2,
        name: 'palestine'.tr,
        flag: 'icon_flag_palestinian.svg',
        isSelected: false),
    Country(
        id: 3,
        name: 'saudi_arabia'.tr,
        flag: 'icon_flag_saudi.svg',
        isSelected: false),
    Country(
        id: 4,
        name: 'uae'.tr,
        flag: 'icon_flag_emirates.svg',
        isSelected: false),
    Country(
        id: 5,
        name: 'kuwait'.tr,
        flag: 'icon_flag_kuwait.svg',
        isSelected: false),
  ];
  ...
  void saveLanguage(String langCode) {
    ...
    PreferencesManager.saveAppLanguage(
