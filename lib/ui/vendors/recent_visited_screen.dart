...
class RecentVisitedScreen extends StatelessWidget {
  RecentVisitedScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: AppColors.colorWhite,
        title: AppText.medium(text: 'recent_visited', color: AppColors.colorAppMain),
        centerTitle: true,
        leadingWidth: 78.w,
        leading: InkWell(
          ...
          children: [
            ...
            Container(
              ...
              child: GridView.builder(
                  ...
                  itemCount: _controller.listVendorsRecent.length,
                  gridDelegate:
                  ...
                  itemBuilder: (context, index) => FavoriteItem(vendor: _controller.listVendorsRecent[index])),
            )
          ],
        ),
      ),
