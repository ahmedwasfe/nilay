...
class ProductsCategoryScreen extends StatelessWidget {
  ...
  ProductsCategoryScreen({this.category, super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: AppColors.colorWhite,
        title: AppText.medium(text: category!.name, color: AppColors.colorAppMain),
        centerTitle: true,
        leadingWidth: 78.w,
        leading: InkWell(
                ...
                children: [
                  Expanded(
                      child: AppText.medium(
                          text: category!.name, color: AppColors.colorAppMain)),
                ],
              ),
            ),
            Container(
